# Sena - Risk Advisory Platform
Sena is an automated risk advisory platform that uses advanced data science to analyze attack data and detect possible attacks. The automation is spearheaded by supervised learning, leveraging both regression and classification methods to draw out more insights on training data. 
