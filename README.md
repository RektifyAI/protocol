...
<b> Projected Launch Date: Q1 2023 - Q3 2024 </b>
  ...
  - The reason it is advantageous for Rektify AI to launch between Q1 2023 - Q3 2024, is to catch the beginning of the 2024 Bitcoin halvening before Bitcoin skyrockets for another bull cycle. 
...
This repository contains Rektify AI's open-source smart contracts, data analysis, data visulizations, and risk metrics. The value proposition for Rektify AI is to be the DeFi risk advisory protocol to bridge the gap between DeFi entrants and DeFi risk education. The main decentralized financial services that have been explored are the following:
...
`**`Automated risk advisory is now being introduced by Rektify AI. There are no other protocols doing what Rektify AI does with limited liability.

----

Until now, risk advisory has been conducted by consultants whom of which, do not have the computing power or statistical leverage to detect potential attacks in Web3 before its occurance. The Rektify AI protocol uses Big Data tactics to automate this procedure. Rektify AI is a prolific risk advisory protocol. The analytical architecture uses data analytics, machine learning, and the decentralized edge to make prescriptive inferences on protocols' risk tolerance. See the [Advanced Attack Analysis repo](https://github.com/SenaLabs/adv-attack-analysis.git) to view the code architecture at the back-end of Sena.
...
- [Deploy RektifyAI](#deploy-sena)
- [History of advisory mechanisms in DeFi](#history-of-advisory-mechanisms-in-defi)
- [License](#license)
- [Resources](#resources)

## Contributing
The Rektify AI protocol is bootstrapped by initial investors and developers if you would like to investor in our protocol please visit our website. 

## Deploy Rektify AI
How to launch Rektify AI:
 1. Fork repository
...
## Resources
If you have an inquiries please post them in the Discord channel titled "help" or send us an email at info@rektify.ai
